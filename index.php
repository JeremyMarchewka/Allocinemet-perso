...
<div class="slider responsive" width='450' height='250'>

    <div src="img/50.jpg"></div>
    <div src="img/51.jpg"></div>
     <div src="img/52.jpg"></div>
    </div>
  </div>

  <div class="title2"><img src="img/decogcutblck.png" id="deco">Nouveautés<img src="img/decodcutblck.png" id="deco"></div>
  ...
  <div class="pres">
     <div class="title2"><img src="img/decogcutblck.png" id="deco">Allocinemet<img src="img/decodcutblck.png" id="deco"></div>
     <div class="row justify-content-md-center">
      <hr class="col-10" style="background-color: red" margin-left="auto">
      </div>
...
$(".slider").each(function(){
  ...
  s.find("div").each(function(i, e){
    sl = $(this); src = sl.attr("src"); sl.removeAttr("src");

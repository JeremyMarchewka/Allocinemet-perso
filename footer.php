...
<footer id="footer" class="page-footer font-small text-white mdb-color pt-4">
    ...
    <div class="container text-center text-md-left ">
      ...
      <div class="row text-center text-md-left mt-3 pb-3 mx-auto">
        ...
        <hr id="ligne" class="w-100 clearfix d-md-none">

        <!-- Grid column -->
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3" id="foot1">
        ...
        <!-- Grid column -->
        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3" id="foot1">
